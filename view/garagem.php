...
$garagem = mysqli_query($conexao, "SELECT * FROM garagem;");
		...
		<div class="row">
			<div class="col-sm-12 col-xs-12">
				...
				<div class="container">
					<nav>
						<ul class="sub-menu">
							<a href="corrida.php"><li>Carros em corrida</li></a>
						</ul>
					</nav>
					<br><br><br>
					<section>
				...
				<?php foreach ($garagem as $dados): ?>
					<tr>	
						...
						<td><a href="javascript: if(confirm('Deseja deletar este veículo ?')) Location.href='Garagem/deletarGaragem.php?ID_VEICULO=<?=$dados["id"]?>'">Deletar</a></td>
						<td><a href="Garagem/corridaVeiculo.php?ID_VEICULO=<?=$dados["id"]?>">Mandar Carro</a></td>
